module.exports = function( grunt ) {
	...
	if ( !grunt.option( "filename" ) ) {
		grunt.option( "filename", "souljs.js" );
	}
	...
	grunt.initConfig( {
		...
		"compare_size": {
			files: [ "dist/souljs.js", "dist/souljs.min.js" ],
			options: {
				compress: {
		...
		babel: {
			...
			nodeSmokeTests: {
				files: {
					"test/data/core/souljs-iterability-transpiled.js":
						"test/data/core/souljs-iterability-transpiled-es6.js"
				}
			}
		},
		build: {
		...
		karma: {
			options: {
				...
				files: [
					...
					{ pattern: "dist/souljs.*", included: false, served: true },
    ...
    // Integrate SoulJS specific tasks
